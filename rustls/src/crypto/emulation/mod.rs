...
use crate::crypto::{SignatureScheme, SupportedCipherSuite};
...
impl FingerprintCipherSuite {
    ...
    pub fn to_cipher_suite(&self) -> crate::crypto::CipherSuite {
...
impl FingerprintSignatureAlgorithm {
    ...
    fn to_mapping_entry(
        ...
        static ECDSA_SHA1_FALLBACK: &[&dyn pki_types::SignatureVerificationAlgorithm] =
            &[webpki_algs_aws::ECDSA_P256_SHA256];
        static ED25519: &[&dyn pki_types::SignatureVerificationAlgorithm] =
            &[webpki_algs_aws::ED25519];
